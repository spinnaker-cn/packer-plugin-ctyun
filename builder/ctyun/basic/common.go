...
const (
	...
	//订单
	VM_MASTER_ORDER_CREATING = "master_order_creating"
	VM_STOPPING              = "stopping"
	VM_STOPPED               = "stopped"
	READY                    = "active"
	IM_QUEUED                = "queued"
	BUILDER_ID               = "mgtv.ctyun"
)
...
type Config struct {
	CTyunCredentialConfig   `mapstructure:",squash"`
	CTyunInstanceSpecConfig `mapstructure:",squash"`
